                ...
                <table class="shop-table">
                    ...
                    <tbody>
                        ...
                        <tr class="cart-item">
                            ...
                            <td class="product-total"><?php echo convert_currency( $item['product_total'])  ?></td>
                        </tr>
                        <?php }?>
                    </tbody>
                    <tfoot>
                        <tr class="order-total">
                            <td>Tổng đơn hàng:</td>
                            <td><strong class="total-price"><?php echo convert_currency($_SESSION['cart']['checkout']['totalCost']) ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
