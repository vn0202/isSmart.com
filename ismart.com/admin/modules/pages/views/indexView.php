                ...
                <div class="section-detail">
                    ...
                    <div class="filter-wp clearfix">
                        ...
                        <ul class="post-status fl-left">
                            <li class="all"><a href="?mod=pages">Tất cả <span class="count">(<?php echo count($listPages)?>)</span></a> |</li>
                    ...
                    <div class="actions">
                        <form method="POST" action="?mod=pages&action=processIndex" class="form-actions">
                            <select name="actions">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <?php $i=0; foreach($listPages as $page){
                                    $i++;
                                     ?>
                                <tr>
