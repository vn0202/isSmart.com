                ...
                <div class="section-detail">
                    ...
                    <div class="filter-wp clearfix">
                        ...
                        <ul class="post-status fl-left">
                            <li class="all"><a href="?mod=pages">Tất cả <span class="count">(<?php echo count($list_garbage)?>)</span></a> |</li>
                            <li class="publish"><a href="">Đã đăng <span class="count">(<?php echo get_number_posted_page()?>)</span></a> |</li>
                            <li class="pending"><a href="?mod=page&action=confirm">Chờ xét duyệt <span class="count">(<?php echo get_number_unconfirm_page()?>)</span> |</a></li>
                    ...
                    <div class="actions">
                        <form method="POST" action="?mod=pages&action=processGarbage" class="form-actions">
                            <select name="actions">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <?php $i=0; foreach($list_garbage as $page){
                                    $i++;
                                     ?>
                                <tr>
