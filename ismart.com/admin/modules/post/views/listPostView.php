        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <div class="actions">
                        <form method="POST" action="?mod=post&action=processListPost" class="form-actions">
                            <select name="actions">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    echo  get_pagin($totalPost, $numberPerPage, $currentPage, "?mod=post&action=showListPost&page=");
