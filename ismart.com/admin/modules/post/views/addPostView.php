            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <input type="text" name="post_title" id="title" value="<?php if(isset($_POST['btn_submit'])) set_value("post_title") ?>"> 
                        <?php  emit_error("post_title")?>
                        <label for="">Mô tả ngắn: </label>
                    <textarea name="post_desc" id="" cols="30" rows="10"><?php if(isset($_POST['btn_submit'])) set_value("post_desc") ?></textarea>
                    ...
                    <?php  emit_error("slug")?>
                        ...
                        <textarea name="post_content" id="desc" class="ckeditor"><?php if(isset($_POST['btn_submit'])) set_value("post_content") ?></textarea>
                    <?php  emit_error("post_content")?>
                        ...
                        <div id="uploadFile">
                            ...
                            <!-- <img src="public/images/img-thumb.png" id="temp_thumb"> -->
                        </div>
