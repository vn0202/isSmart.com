        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=product&action=showListProduct" title="" id="add-new" class="fl-left">Quay lại danh sách </a>
                </div>
            </div>
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <p id="desc" class="fl-left">Chọn vào checkbox để lựa chọn tất cả</p>
                   <?php 
                     $totalProduct=get_total_garbage();
                     echo get_pagin($totalProduct,$currentPage,"?mod=product&action=showPostedProduct&page=");
